...
Note Creation: Create, view, edit, and delete notes.
...
Searchable Notes: Easily search your notes by title.
...
AI Integration: Placeholder buttons for AI features (currently non-functional, can be replaced with an AI API of choice).